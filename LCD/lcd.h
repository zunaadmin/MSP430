...
**   Description: This is include file for LCD libray for MSP430
***/
#ifndef __lcd_h__
#define __lcd_h__

#include <msp430g2553.h>               // Peripheral Address
#include <stdio.h>
...
#define DELAY_VAL         (unsigned long)16000        // Delay value (16000 : 16Mhz, 1000 : 1Mhz)
#define DELAY_us_VAL      (unsigned long)(DELAY_VAL/1000)


// LCD Pin definitions
// RS of LCD Direction,OUTPUT and Bit Position
#define LCD_RS_PORT P2OUT
#define LCD_RS_DIR  P2DIR
