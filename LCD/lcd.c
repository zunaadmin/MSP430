...
**   Description: This is the lcd driver for MSP430
***/
...
// If 8- Bit Mode
#if   LCD_MODE == 1
// SET D0 Port as OUTPUT and Write LOW to PORT
LCD_D0_DIR  |= LCD_D0_BIT;
LCD_D0_PORT &= ~LCD_D0_BIT;
// SET D1 Port as OUTPUT and Write LOW to PORT
LCD_D1_DIR  |= LCD_D1_BIT;
LCD_D1_PORT &= ~LCD_D1_BIT;
// SET D2 Port as OUTPUT and Write LOW to PORT
LCD_D2_DIR  |= LCD_D2_BIT;
LCD_D2_PORT &= ~LCD_D2_BIT;
// SET D3 Port as OUTPUT and Write LOW to PORT
LCD_D3_DIR  |= LCD_D3_BIT;
LCD_D3_PORT &= ~LCD_D3_BIT;
// SET D4 Port as OUTPUT and Write LOW to PORT
LCD_D4_DIR  |= LCD_D4_BIT;
LCD_D4_PORT &= ~LCD_D4_BIT;
// SET D5 Port as OUTPUT and Write LOW to PORT
LCD_D5_DIR  |= LCD_D5_BIT;
LCD_D5_PORT &= ~LCD_D5_BIT;
// SET D6 Port as OUTPUT and Write LOW to PORT
LCD_D6_DIR  |= LCD_D6_BIT;
LCD_D6_PORT &= ~LCD_D6_BIT;
// SET D7 Port as OUTPUT and Write LOW to PORT
